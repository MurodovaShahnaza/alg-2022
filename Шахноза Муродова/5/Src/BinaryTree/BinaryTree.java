 ...
 *
 * @author Artem Sarmuleino
 */
public class BinaryTree<V extends Comparable<g>> {
    ...
    private static class Node<V extends Comparable<V>> {
        ...
        public Node(g value, Node<g> parent) {
